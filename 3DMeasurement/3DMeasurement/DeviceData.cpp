...
/*
 ...
 @return Device status
*/
QString CDeviceData::GetStatusString(void)
{
    QString status = NULL;
...
//			status.Format(("Ethernet---%d.%d.%d.%d")
...
//				,m_ethernetConfig.abyIpAddress[3]);
            status = QString("%1.%2.%3.%4").arg(m_ethernetConfig.abyIpAddress[0])
                                     .arg(m_ethernetConfig.abyIpAddress[1])
                                     .arg(m_ethernetConfig.abyIpAddress[2])
                                     .arg(m_ethernetConfig.abyIpAddress[3]);
			break;
